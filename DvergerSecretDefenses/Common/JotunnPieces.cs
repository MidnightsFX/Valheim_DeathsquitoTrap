...
namespace DvergerSecretDefenses.Common {
    public static class JotunnPiece {
        ...
        public static void RegisterJotunnPiece(JotunnBuildPiece jbuildpiece) {
            ...
            LGos.Prefab = DvergerSecretDefenses.EmbeddedResourceBundle.LoadAsset<GameObject>($"{jbuildpiece.Prefab}.prefab");
            LGos.Sprite = DvergerSecretDefenses.EmbeddedResourceBundle.LoadAsset<Sprite>($"{jbuildpiece.Sprite}.png");
